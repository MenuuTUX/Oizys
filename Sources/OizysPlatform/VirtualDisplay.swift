...
@_cdecl("oizys_virtual_display_create")
func createVirtualDisplay(_ description: UnsafePointer<OizysVirtualDisplayDesc>?) -> UnsafeMutableRawPointer? {
    ...
    descriptor.setValue(desc.name.map(String.init(cString:)) ?? "Oizys", forKey: "name")
    ...
    descriptor.setValue(DispatchQueue(label: "org.oizys.display"), forKey: "dispatchQueue")
...
@_cdecl("oizys_virtual_display_id")
...
@_cdecl("oizys_virtual_display_destroy")
